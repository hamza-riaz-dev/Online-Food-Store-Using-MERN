...
export default function Cart() {
    ...
    return (
        <div className='container m-auto mt-5 table-responsive table-responsive-sm table-responsive-md'>
                ...
                <tbody>
                    {data.map((item, index) => (
                        <tr>
                            ...
                            <td>{item.price}</td>
                            <td>
                                <button type='button' className='btn btn-danger p-1 float-end' onClick={() => { dispatch({ type: "REMOVE", index: index }) }}>
                                    Remove
                                </button>
                            </td>
                        </tr>
            ...
            <button className='btn btn-success mt-5' onClick={checkOut}>Check Out</button>
        </div>
    )
}
